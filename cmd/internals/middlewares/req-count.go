...
//		return
//	}
//	_ = nats.SendReqCountEvent(uid.(string), "Auth", c.Request.Method, senderIp, c.Request.URL.String(), class)
//}
//
...
//		return
//	}
//	_ = nats.SendReqCountEvent(key.(*arango.AccessKey).Id, "AccessKey", c.Request.Method, senderIp, c.Request.URL.String(), class)
//}
//
...
//		return
//	}
//	_ = nats.SendReqCountEvent(kp.(*arango.KeyPair).Public, "Signed", c.Request.Method, senderIp, c.Request.URL.String(), class)
//}
